...
export function GameProvider({
  ...
  }), [authToken, username, snapshot, serverTimeOffset, adminSpeed, sparkleUntil, scoutIntel, banner, resuming, authError, call, doAction, applySnapshot, login, register, logout, mapView, selectedVillage, openVillageAction, closeVillageAction, activeTab, playerProfile, openPlayerProfile, closePlayerProfile, goToVillageOnMap, tutorialOpen, closeTutorial, replayTutorial, getVillageResourceBonus]);
