...
export default function ReportsTab() {
  ...
  function onContainerClick(e) {
    ...
    if (openProfileEl) {
      e.stopPropagation();
      openPlayerProfile(openProfileEl.dataset.openProfile);
      return;
    }
    const delEl = e.target.closest("[data-delete-report]");
    if (delEl) {
      e.stopPropagation();
      doAction(() => call("/api/reports/delete", "POST", {
        ids: [delEl.dataset.deleteReport]
      }), "🗑️ Rapport supprimé", null);
      return;
    }
    const acceptEl = e.target.closest("[data-guild-invite-accept]");
    if (acceptEl) {
      e.stopPropagation();
      doAction(() => call("/api/guild/accept", "POST", {
        guildId: acceptEl.dataset.guildInviteAccept
      }), "👥 Vous avez rejoint la guilde !", null);
      return;
    }
    const declineEl = e.target.closest("[data-guild-invite-decline]");
    if (declineEl) {
      e.stopPropagation();
      doAction(() => call("/api/guild/decline", "POST", {
        guildId: declineEl.dataset.guildInviteDecline
      }), "Invitation refusée.", null);
      return;
    }
  ...
  function clearReports() {
    ...
    doAction(() => call("/api/reports/clear", "POST", {
      kind
    }), "🗑️ Rapports supprimés", null);
  }
  ...
  if (!reports.length) {
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", null, "Rapports"), filterBar, /*#__PURE__*/React.createElement("p", {
      className: "muted"
  ...
  const bulkBar = /*#__PURE__*/React.createElement("div", {
  ...
  }, filtered.length, " rapport", filtered.length > 1 ? "s" : "", " affich\xE9", filtered.length > 1 ? "s" : ""), /*#__PURE__*/React.createElement("button", {
    className: "small",
    disabled: !filtered.length,
    onClick: clearReports
  }, "\uD83D\uDDD1\uFE0F Supprimer ", bulkLabel));
  if (!filtered.length) {
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", null, "Rapports"), filterBar, bulkBar, /*#__PURE__*/React.createElement("p", {
      className: "muted"
    }, "Aucun rapport dans cette cat\xE9gorie."));
  }
  const itemsHtml = filtered.map(r => reportRowHtml(r, openReport.has(r.id), now)).join("");
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", null, "Rapports"), filterBar, bulkBar, /*#__PURE__*/React.createElement("div", {
