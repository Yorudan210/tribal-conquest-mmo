...
function villageMapIconSvg(kind, level, hasWall) {
  ...
  const huts = level <= 0 ? hut(0, 2, 1, 0, true) : level === 1 ? hut(-8, -2, 0.85, -10, false) + hut(7, 5, 0.95, 8, true) : hut(-1, -7, 0.85, -4, true) + hut(-11, 5, 0.78, -14, false) + hut(10, 4, 0.82, 12, false);
