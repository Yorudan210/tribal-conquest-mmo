...
export function nobleReportLine(r) {
  ...
  const escortNote = r.nobleEscortSurvivorPct != null ? ` (escorte revenue : ${r.nobleEscortSurvivorPct}% — il en fallait au moins 20% pour que le Noble survive au combat)` : "";
  let outcome;
