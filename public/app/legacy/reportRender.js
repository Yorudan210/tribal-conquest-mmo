...
export const DIPLOMACY_LABEL_LOWER = {
  pact: "un pacte de non-agression",
  alliance: "une alliance",
  war: "un état de guerre"
};
export const REPORT_FILTERS = [{
  ...
  key: "attack",
  label: "⚔️ Attaques envoyées"
}, {
  key: "defense",
  label: "🛡️ Attaques subies"
}, {
  key: "scout",
  label: "🔭 Reconnaissances",
  kinds: ["scout", "scoutDefense"]
}, {
  key: "raid",
  label: "⚠️ Raids de pillards"
}, {
  key: "support",
  label: "🤝 Soutien",
  kinds: ["supportIn", "supportOut"]
}, {
  key: "gift",
  label: "🎁 Dons",
  kinds: ["giftIn", "giftOut"]
}, {
  key: "market",
  label: "🏪 Marché",
  kinds: ["marketSold", "marketBought"]
}, {
  key: "guildInvite",
  label: "👥 Guilde"
}, {
  key: "diplomacy",
  label: "🕊️ Diplomatie",
  kinds: ["diplomacyProposal", "diplomacyAccepted", "diplomacyDeclined", "diplomacyEnded", "diplomacyWar"]
}, {
  key: "announcement",
  label: "📢 Annonces"
}];
export function reportMatchesFilter(r, f) {
  return f.kinds ? f.kinds.includes(r.kind) : r.kind === f.key;
}
