...
function villageMapIconSvg(kind, level, hasWall){
  ...
  const palisade = hasWall
    ? `<ellipse cx="0" cy="${groundCy}" rx="${groundRx+4}" ry="${groundRy+4}" fill="none" stroke="${black?'#3a1414':legendary?'#6b4a12':raiders?'#5a2f18':bandits?'#453552':'#5a4326'}" stroke-width="2.2" stroke-dasharray="3.5 3" opacity="0.85"/>`
    : "";
