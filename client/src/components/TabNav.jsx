...
export default function TabNav({ activeTab, setActiveTab }){
  ...
  const tabs = [
    ["buildings", "🏗️ Bâtiments"],
    ["barracks", "⚔️ Caserne"],
    ["commander", "🎖️ Commandant" + (s.commander ? (" (niv. " + s.commander.level + ")") : "")],
    ["map", "🗺️ Carte"],
    ["farm", "🌾 Pillage"],
    ["guild", "👥 Guilde" + (s.guild ? (" — " + s.guild.tag) : "")],
    ["market", "🏪 Marché" + ((s.market||[]).length ? (" (" + s.market.length + ")") : "")],
    ["leaderboard", "🏆 Classement"],
    ["reports", "📜 Rapports (" + s.reports.length + ")"],
  ];
